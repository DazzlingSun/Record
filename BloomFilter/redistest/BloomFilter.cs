...
namespace redistest
{
    ...
    public class BloomFilter<T>
    {
        ...
        /// <summary>
        /// 计算遇到误检率的概率。   可信度降到百分之零点几
        /// </summary>
        /// <returns>Probability of a false positive</returns>
        public double FalsePositiveProbability()
        {
            var ddd = Math.Pow((1 - Math.Exp(-_numberOfHashes * _setSize / (double)_bitSize)), _numberOfHashes);
        ...
        ///计算基于布隆过滤器散列的最佳数量--k 
        /// </summary>
        /// <param name="bitSize">m</param>
        /// <param name="setSize">n</param>
        /// <returns></returns>
        public int OptimalNumberOfHashes(int bitSize, int setSize)
        {
